...
namespace Minigame8
{
    public class BuildObject : MonoBehaviour
    {
        ...
        void OnMouseEnter()
        {
            MiniGame8_Manager.instance.WasMouseOverObject(this);
        }
        ...
        void OnMouseExit()
        {
            MiniGame8_Manager.instance.WasMouseNoMoreOverObject(this);
        }

        void OnMouseDown()
        {
            MiniGame8_Manager.instance.WasClickObject(this);
        }
