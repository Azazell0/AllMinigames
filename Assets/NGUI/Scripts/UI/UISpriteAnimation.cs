...
public class UISpriteAnimation : MonoBehaviour
{
    ...
    [HideInInspector][SerializeField] float delay = 0f;
    ...
    public float animDelay { get { return delay; } set { delay = value; } }
	...
	void Update ()
	{
        if (mActive && mSpriteNames.Count > 1 && Application.isPlaying && mFPS > 0f && _currentDelay > delay)
		{
        ...
        _currentDelay += RealTime.deltaTime;
	}
